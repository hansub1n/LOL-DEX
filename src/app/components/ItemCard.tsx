...
export const ItemCard = ({ data }: { data: Item[] }) => {
	return (
		<div className="grid grid-cols-5 gap-[35px]">
			{data.map((item) => (
				<div
					key={item.id}
					className="relative group flex flex-col items-center justify-around w-[240px] h-[320px] rounded-[10px] bg-[#010101] border border-[#C8AA6E] shadow-lg transition-transform duration-300 hover:translate-y-[-10px] hover:shadow-2xl"
				>
					<Image
						width={100}
						height={100}
